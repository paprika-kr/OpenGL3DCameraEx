...
#define TEXTURE_ID_DRAGON 4
#define TEXTURE_ID_GODZILLA 5
#define TEXTURE_ID_BUS 6
#define TEXTURE_ID_BIKE 7
#define TEXTURE_ID_TANK 8
#define TEXTURE_ID_OPTIMUS 9
...
void prepare_floor(void) { // Draw coordinate axes.
	...
	glBindTexture(GL_TEXTURE_2D, texture_names[TEXTURE_ID_FLOOR]);
		 ...
		 My_glTexImage2D_from_file("Data/static_objects/tex/concrete_tex.jpg");
	//My_glTexImage2D_from_file("Data/static_objects/tex/checker_tex.jpg");
...
void prepare_wolf(void) {
	...
	*/
	...
	My_glTexImage2D_from_file("Data/dynamic_objects/wolf/wolf_tex.jpg");
...
void prepare_spider(void) {
	...
	My_glTexImage2D_from_file("Data/dynamic_objects/spider/spider_tex2.jpg");
...
void prepare_dragon(void) {
	...
	My_glTexImage2D_from_file("Data/static_objects/tex/dragon_tex2.jpg");
...
void prepare_godzilla(void) {
	...
	My_glTexImage2D_from_file("Data/static_objects/tex/godzilla_tex2.jpg");
...
void prepare_bus(void) {
	...
	My_glTexImage2D_from_file("Data/static_objects/tex/bus_tex.jpg");
...
void prepare_bike(void) {
	...
	My_glTexImage2D_from_file("Data/static_objects/tex/bike_tex2.jpg");
...
void prepare_tank(void) {
	...
	My_glTexImage2D_from_file("Data/static_objects/tex/tank_tex.jpg");
...
void prepare_optimus(void) {
	...
	glActiveTexture(GL_TEXTURE0 + TEXTURE_ID_OPTIMUS);
	glBindTexture(GL_TEXTURE_2D, texture_names[TEXTURE_ID_OPTIMUS]);

	My_glTexImage2D_from_file("Data/static_objects/tex/optimus_tex.jpg");
